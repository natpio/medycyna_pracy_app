...
def create_kbp_pdf(orz_data, wizyta, pacjent, firma, signature_path, fonts):
    ...
    pdf.cell(30, 5, " Nr z wykazu chorób: ")
    ...
    pdf.print_options(["Tak", "Nie"], 1, 5, " / ")
    pdf.cell(10, 5, "  kiedy? ")
    pdf.cell(30, 5, "", border="B")
    pdf.cell(30, 5, " z jakiego powodu? ")
    pdf.cell(0, 5, "", border="B", ln=1)
    ...
    pdf.set_font("Roboto", size=8)
    pdf.cell(30, 5, "Skargi badanego (ej): ")
    pdf.cell(0, 5, "", border="B", ln=1)
    pdf.cell(0, 5, "", border="B", ln=1)
    ...
    pdf.cell(20, 5, "    opis uwagi: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.ln(2)
    pdf.cell(90, 5, "Czy badany(a) przebył(a) zabieg / i operacyjny/e? Jakie? Kiedy?")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.cell(80, 5, "Czy jest pod opieką poradni specjalistycznej? Jakiej?")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.cell(60, 5, "Czy badany(a) przyjmuje leki? Jakie?")
    pdf.cell(0, 5, "", border="B", ln=1)
    ...
    pdf.set_font("Roboto", size=8)
    pdf.cell(80, 5, "Zakres badań poszerzony poza wskazówki metodyczne:   ")
    pdf.print_options(["NIE", "TAK"], 0, 5, " / ")
    pdf.cell(20, 5, " Uzasadnienie: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.cell(80, 5, "Zmiana częstotliwości wykonywania badań okresowych:   ")
    pdf.print_options(["NIE", "TAK"], 0, 5, " / ")
    pdf.cell(20, 5, " Uzasadnienie: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.ln(3)
    pdf.cell(20, 5, "Rozpoznanie: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.cell(75, 5, "Dane adresowe jednostki podstawowej opieki zdrowotnej: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.cell(50, 5, "Informacje dla lekarza rodzinnego: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    
    pdf.cell(15, 5, "Zalecenia: ")
    pdf.cell(0, 5, "", border="B", ln=1)
    ...
    pdf.cell(125, 5, "Badany(a) / podmiot kierujący na badanie odwołuje się do treści orzeczenia lekarskiego do ")
    pdf.cell(40, 5, "", border="B")
    pdf.cell(10, 5, " w dniu ")
    pdf.cell(0, 5, "", border="B", ln=1)
    ...
    pdf.cell(110, 5, f"Dokumentację medyczną wydano osobie badanej do jednostki odwoławczej w dniu: ")
    pdf.cell(40, 5, "", border="B")
